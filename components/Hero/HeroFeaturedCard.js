import styles from "./HeroFeaturedCard.module.scss";
import ThumbsButtons from "../Buttons/ThumbsButtons";

export default function HeroFeaturedCard() {
  return (
    <div className={styles.contentContainer}>
      <div className={styles.featuredCardBackground}></div>
      <div className={styles.organicer}>
        <p className={styles.introFrase}>What’s your opinion on</p>
        <h2 className={styles.title}>Pope Francis?</h2>
        ...
        <p className={styles.moreInfo}>
          <a href="http://wikipedia.com">
            <svg
              ...
              viewBox="0 0 27 18"
              className={styles.wikipediaLogo}
            >
              <path
        ...
        <p className={styles.lastQuestion}>What’s Your Veredict?</p>
        <div className={styles.thumbsButtonsContainer}>
          <ThumbsButtons />
        </div>
      </div>
    </div>
